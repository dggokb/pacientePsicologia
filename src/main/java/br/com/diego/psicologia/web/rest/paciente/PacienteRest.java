package br.com.diego.psicologia.web.rest.paciente;
...
import br.com.diego.psicologia.servico.paciente.altera.AlteraPaciente;
import br.com.diego.psicologia.servico.paciente.altera.AlterarPaciente;
import br.com.diego.psicologia.servico.paciente.ativa.AtivaPaciente;
import br.com.diego.psicologia.servico.paciente.consulta.*;
...
public class PacienteRest {
    ...
    private AdicionarPaciente criarComandoParaAdicionar(AdicionaPacienteHttpDTO httpDTO) {
        return new AdicionarPaciente(httpDTO.usuarioId, httpDTO.nome, httpDTO.endereco,
